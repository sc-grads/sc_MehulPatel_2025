...
-- Finding the missing index and re-run the above 
USE [AdventureWorks2022]
GO
CREATE NONCLUSTERED INDEX IDK_salesOrderDetail_CarrierTrackingNumber
...
-- Use Pagination (fetches the roles you are interested in)
